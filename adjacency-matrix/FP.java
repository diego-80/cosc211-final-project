...
public class FP {
    public static void main(String[] args){
        ...
        //create graph
            //adj matrix based on indices of wordArray (hashVals), ints for num of an edge, plus an array for count of each word
        //analysis
        String filename;
        if(args.length==0)
        ...
        try {
            ...
            AdjMatrix graph = new AdjMatrix(hashVals.length);
            int fromHash=-1;
            int toHash=-1;
